      ...
      <Grid container spacing={3} direction="column" alignItems="center" justify="center">
        <Grid item xs container direction="column" justify="center" alignItems="center">
          <Paper className={classes.paper} >
            <Box>
              Rate your experience with the Self-Guided Study
            </Box>
          </Paper>
        </Grid>
        <Grid item xs container direction="column" justify="center" alignItems="center" spacing={3}>
          ...
          <Grid item xs container direction="column" spacing={1}>
            <Grid item xs>
              <Box fontWeight="700">
                Input Suggested Material Quality
              </Box>
            </Grid>
            <Grid item xs>
          ...
          <Grid item xs container direction="column" spacing={1}>
            ...
            <Grid item xs>
              <TimeSlider step={0} value={props.study.expectedTime}/>
            </Grid>
          </Grid>
          ...
          <Grid item xs container direction="column" spacing={1}>
            ...
            <Grid item xs>
              <TimeSlider step={0} value={props.study.realTime}/>
            </Grid>
          </Grid>
