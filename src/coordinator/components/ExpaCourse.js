...
export default function ControlledExpansionPanels(props) {
    ...
    return (
        <div className={classes.root}>
            <div style={{ width: expanded? '1550px': '1300px', padding:0,margin:0,borderRadius: '10px 8px 8px 8px', border: expanded? '2px outset':null, borderColor: expanded? props.colour:null, zIndex: '0'}}>
            <ExpansionPanel onChange={handleChange('panel1')} >
                ...
                <p style = {{position:'relative',top:'14px',left:'15px', fontWeight: '500', width: '90%', fontSize: '22px', wordWrap: 'break-word',overflowWrap: 'break-word', display: 'flex', alignItems: 'center', color: 'white'}}> Course Dashboard </p>
                <Typography style={{position:'relative', marginBottom: '17px', verticalAlign:'middle' , left:'15px', float:'left', fontSize: '18px', fontWeight:'300', color: 'white', paddingBottom: '0.5px'}}><b> Total Students &nbsp;</b> <PersonIcon className={classes.iconS} style={{ fontSize: 22 , verticalAlign:'middle'}} /> {props.course.total_students} &nbsp;</Typography>
                </div>
                :
