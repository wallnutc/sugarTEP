    ...
    return (
        <div className={classes.root}>
            ...
            <ExpansionPanel onChange={handleChange('panel1')}>
                ...
                <Typography style={{position:'absolute', bottom:'0px',left:'30px', marginBottom: '19px', verticalAlign:'middle' , float:'left', fontSize: '18px', fontWeight:'500', color: 'white', paddingBottom: '0.5px'}}> <b> Total Students &nbsp;</b> <PersonIcon className={classes.iconS} style={{ fontSize: 22 , verticalAlign:'middle'}} /> {props.course.total_students} &nbsp;</Typography>
                </div>
                :
