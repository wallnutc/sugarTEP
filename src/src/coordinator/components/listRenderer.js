  ...
  return (
    ...
    <ExpansionPanel style={{border:'1px solid '+props.item.colour, backgroundColor:props.item.colour, color: 'white', opacity: new Date(props.item.date+'T00:00:00') < props.today? 0.5:1}} >
        <ExpansionPanelSummary  style = {{height:'56px',padding:0,alignItems:'normal'}} onClick={()=>setExpanded(!expanded)}>
          <div style = {{width:'100%'}}>
            <div style = {{float:'left',position:'relative',left: 0,height:'100%', width:'56px',margin:0, borderRadius:expanded?'8px 0 0 0':'8px 0 0 8px',backgroundColor:'white'}}>
      ...
      <ExpansionPanelDetails style={{padding:'8px',borderRadius:'0 0 8px 8px', backgroundColor:"white"}}>
        <div style={{width:'100%', color:props.item.colour,backgroundColor: "white"}} >
            <span style={{marginRight:'16px',float:'right'}}><LocationOnOutlinedIcon color='action' style={{fontSize:'14px',color:props.item.colour}}/> {props.item.location}</span>
            ...
            </div>
            {
              <div>
                ...
                style={{lineHeight:0,float:'right',height: '28px',borderRadius:'28px',textTransform: 'none', padding:0, backgroundColor:props.item.colour,}} children ={<span style={{inlineHeight:'0',color:"white"}}>Check Details</span>}></Button>
              </div>
              }
...
export function ActivityPanel(props) {
  ...
  return (
    ...
    <ExpansionPanel style={{border:'1px solid '+props.item.colour  ,backgroundColor: props.item.colour, color: 'white'}}>
      ...
      <ExpansionPanelDetails style={{padding:'8px',borderRadius:'0 0 8px 8px', backgroundColor:"white"}}>
        <div style = {{textAlign: 'justify', fontWeight: 'normal', fontSize: '11px', lineHeight: '17px',width: '100%', color: props.item.colour}}>
          ...
          <div style={{margin:'17px 0'}}>
            {
              ...
              style={{lineHeight:0, height: '28px',borderRadius:'28px',textTransform: 'none', padding:0, backgroundColor:props.item.colour,}} children ={<span style={{inlineHeight:'0',color:"white"}}>Check Details</span>}></Button>
