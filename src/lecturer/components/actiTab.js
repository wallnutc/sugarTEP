  ...
  return (
    <div  className={classes.root} style = {{height:'400px',borderRight: '1px solid #C4C4C4',}}>
      ...
      <TabPanel  value={value} index={0} >
        ...
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Exponential Functions</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>Today</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Algebra 1</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>25th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Linear Programming</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}> 20th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Matrices</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}> 18th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Probability</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>13th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Statistics</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>13th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Linear Algebra</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>13th March</span></div></div>} />
        </div>
        <div style = {{margin:'8px 0'}}> <BootstrapButton  size = 'large' fullWidth startIcon ={<AssignmentIcon color='action' style={{fontSize: 40 }} />} children={<div><div style={{fontFamily: 'Rubik'}}>Calculus</div><div style={{fontWeight:'300',fontSize: '14px'}}><ScheduleIcon color='action' style={{verticalAlign:'middle',fontWeight:'300',fontSize: '14px'}} /> <span style={{verticalAlign:'middle'}}>13th March</span></div></div>} />
        </div>
