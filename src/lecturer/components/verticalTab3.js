    ...
    <div className={classes.root}>
      ...
      <div >
        ...
        >
          ...
          <Tab fullWidth style = {{ height:'80px',maxWidth:'500px', textTransform: 'none', fontSize:18}} label={<div style={{marginLeft:'30px'}}><LocalLibraryIcon color='action' style={{fontSize:"50px",verticalAlign:'middle'}} /> Lectures</div>} {...a11yProps(1)} />
          <Tab fullWidth style = {{ height:'80px',maxWidth:'500px', textTransform: 'none', fontSize:18 }} label={<div style={{marginLeft:'30px'}}><ComputerIcon color='action' style={{fontSize:"50px",verticalAlign:'middle'}} /> Activities</div>} {...a11yProps(2)} />
          <Tab fullWidth style = {{ height:'80px',maxWidth:'500px', textTransform: 'none', fontSize:18 }} label={<div style={{marginLeft:'30px'}}><MenuBookIcon color='action' style={{fontSize:"50px",verticalAlign:'middle'}} /> Guided Study</div>} {...a11yProps(3)} />
          <Tab fullWidth style = {{ height:'80px',maxWidth:'500px', textTransform: 'none', fontSize:18 }} label={<div style={{marginLeft:'30px'}}><BarChartIcon color='action' style={{fontSize:"50px",verticalAlign:'middle'}} /> Student Experience</div>} {...a11yProps(4)} />
        </Tabs>
        </div>
