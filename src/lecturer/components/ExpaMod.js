...
export default function ControlledExpansionPanels(props) {
    ...
    return (
        <div className={classes.root}>
            ...
            <ExpansionPanel onChange={handleChange('panel1')} >
                ...
                { expanded? <div style = {{ position:'relative', height: '100px', width:'317px', backgroundColor: props.module.colour, borderRadius: '8px 0px 0px 0px',fontFamily: 'Rubik', fontStyle: 'normal'}}>
                <p style = {{position:'relative',top:'24',left:'29px', fontWeight: '500', fontSize: '18px', display: 'flex', alignItems: 'center', color: 'white'}}> {props.module.module_code + ' - ' + props.module.module_name} </p>
    <Typography style={{position:'relative', verticalAlign:'middle' , left:'29px', float:'left', fontSize: '15px', fontWeight:'500', color: 'white', paddingBottom: '0.5px'}}> <PersonIcon className={classes.iconS} style={{ fontSize: 22 , verticalAlign:'middle'}} /> {props.module.total_students} &nbsp; <b>ECTS</b> {props.module.credits}</Typography>
                ...
                :
                  <div style={{height:'76px', width:'100%', padding:'0px 30px',backgroundColor: props.module.colour, borderRadius: '8px', verticalAlign:'middle'}}>
